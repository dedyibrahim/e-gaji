...
<li><a><i class="fa fa-pencil-square-o"></i>INPUT<span class="fa fa-chevron-down"></span></a>
<ul class="nav child_menu">
<li><a href="<?php echo  base_url('C_admin/input_karyawan'); ?>">INPUT KARYAWAN</a></li>
<li><a href="<?php echo base_url('C_admin/input_pendapatan'); ?>">INPUT PENDAPATAN</a></li>
</ul>
</li>
